        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <asp:TemplateField ShowHeader="False" HeaderText="Eliminar">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButtonEliminar" runat="server" CommandName="Eliminar" CssClass="btn btn-danger">Eliminar</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
               ...
               <asp:BoundField  Visible="true" DataField="Fecha" HeaderText="Fecha" />
                     ...
                     <asp:BoundField  Visible="true" DataField="Horario" HeaderText="Horario" ControlStyle-CssClass="" ControlStyle-Font-Bold="true" />
